...
import ChangePassStep1 from "./ChangePassStep1";
import ChangePassStep2 from "./ChangePassStep2";
import ChangePassStep3 from "./ChangePassStep3";
...
export default function ChangePass(props: {
  ...
  return (
    <div>
      ...
      {props.State.step === 2 && (
        <ChangePassStep2 {...props} HandleResetPassword={HandleResetPassword} />
      )}
      {props.State.step === 3 && (
        <ChangePassStep3 {...props} setOpenModal={props.setOpenModal} />
      )}
    </div>
  );
}
