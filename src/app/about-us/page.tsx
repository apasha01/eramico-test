...
import Background from "../img/aboutUsBackGround.svg";
import { ABOUT_US } from "@/lib/urls";
import { Metadata } from "next";
import { GetMetadata } from "@/lib/metadata";
import PageHeader from "@/Components/common/page-header";

interface AboutUS_res extends IAPIResult<any> {}

const getData = cache(async () => {
  const response = await axiosInstance.get<AboutUS_res>(
    ABOUT_US,
