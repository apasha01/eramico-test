...
import PositionSelectorModal from "@/Components/common/submit-position";
import CompanyEditModal from "./@componenets/company-edit-modal";
      ...
      <div className="headerStyle" dir="rtl">
        <div className="headerTitleBoxStyle">
          <div className="headerBackRowStyle header-item">
            <BackButton />
            <div className="px-0 ms-0 me-3 d-flex align-items-center">
              <TheAvatar
                src={avatar || ""}
                name={localTitle}
                variant="rounded"
            ...
            <div className="mx-2">
              <div className="row mx-0 col-12">
                <div className="px-0  align-items-center gap-1">
                  <Typography
                  ...
                  {isMine && <CompanyEditModal props={company} />}
                  {isMine && (
                    <Button
                      sx={{
              ...
              <div className="d-flex gap-2 mx-0 col-12 fs-11 mt-1 align-items-center">
                {code && (
                  <>
                ...
                <div className="d-flex" onClick={() => setSelectedView(5)}>
                  ...
                  <span className="fs-11 mt-1">نفر دنبال کننده</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="header-item">
            {!isMine && (
              <>
                <Button
                  ...
                  startIcon={
                    !isSubscribed ? (
                      ...
                      <FaCheck style={{ color: "#616161" }} color="#616161" />
                    )
                  }
                >
                ...
                {!isMine && <PositionSelectorModal CompanyId={Number(id)} />}
              </>
            )}
          </div>
        </div>
