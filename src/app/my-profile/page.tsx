...
import { MY_FEED } from "@/lib/urls";
import FeedItem from "@/Components/Home/Main/FeedItem";
import { PAGE_SIZE } from "@/lib/constants";
import { useUserState } from "@/Hooks/useUserState";
import { GetMetadata } from "@/lib/metadata";

interface Feed_res extends IAPIResult<Data[]> {}

export default function Page() {
  var md = GetMetadata('پروفایل من');
      ...
      <div className="col w-100 p-4 mb-3">
        ...
        <div className="col BorderBottom w-100 p-4 mb-3">
          {items.length > 0 ? (
            ...
            !loading && <span>مطلبی توسط شما منتشر نشده‌است.</span>
          )}
        </div>
      </div>
    </div>
